...
!(function (o) {
		...
		o(".side-nav").length &&
			...
			o(".side-nav a").each(function () {
				...
				this.href == e &&
					...
					"wrapper" !==
						(e = o(this).parent().parent().parent().parent().parent().parent().parent().parent().parent()).attr("id") &&
						e.addClass("show"),
					(e = o(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent()).is(
						"body"
	...
	e(),
		...
		jQuery().timepicker &&
			((c = { showSeconds: !0, icons: { up: "mdi mdi-chevron-up", down: "mdi mdi-chevron-down" } }),
